package com.chinaservices.oms.edi.event.wmsasn;
 ...
 * @author Samuel
 */
public class WmsAsnRevocationOrderEvent extends Event {

	private String[] customer_order_no;

	private Integer operator;

	public WmsAsnRevocationOrderEvent(String[] customer_order_no, Integer operator) {
