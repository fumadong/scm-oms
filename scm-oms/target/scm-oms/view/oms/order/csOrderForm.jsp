		...
		<form class="layui-form" action="" id="form-add">
		        ...
		        <div class="layui-colla-content layui-show"> 
					<div class="layui-form-item">
						...
						<div class="layui-inline"> 
				        	...
				        	<div class="layui-input-inline">
			           			<input type="text" id="customer_order_no" name="customer_order_no" autocomplete="off" class="layui-input">
			           		</div>
						</div>
						<div class="layui-inline"> 
						...
						<div class="layui-inline">
				        	...
				        	<div class="layui-input-inline">
			           			<fm:select id="order_type" name="order_type" dictType="order_type" lay_filter="order_type" lay_verify="required" itemValue="value" itemLabel="label" cssClass="col-xs-7"/>
			           		</div>
						</div>
						<div class="layui-inline">
				        	<label class="layui-form-label"><span class="c-red">*</span>计费节点</label>
				        	<div class="layui-input-inline">
		           				<fm:select id="charge_node" name="charge_node" dictType="charge_node" lay_verify="required" itemValue="value" itemLabel="label" cssClass="col-xs-7"/>
			           		</div>
						</div>
						<div class="layui-inline"> 
						...
						<div class="layui-inline"> 
				        	<label class="layui-form-label"><span class="c-red">*</span>是否需要签收</label>
				        	<div class="layui-input-inline">
			           			<fm:select id="is_sign" name="is_sign" dictType="yes_no" lay_verify="required" itemValue="value" itemLabel="label" cssClass="col-xs-7"/>
			           		</div>
						</div>
						<!-- 第四行 -->
						<div class="layui-inline"> 
			...
			<div class="layui-colla-item">	
		        ...
		        <div class="layui-colla-content layui-show"> 
					<div class="layui-form-item">
						...
						<div class="layui-inline">
							...
							<div class="layui-input-inline">
								<input type="text" id="shipper_code" name="shipper_code" autocomplete="off" class="layui-input layui-hide">
			           			<input type="text" id="shipper_name" name="shipper_name" autocomplete="off" lay-verify="required" placeholder="请选择或输入客户" class="layui-input popup col-xs-12"/>
						...
						<div class="layui-inline"> 
				        	...
				        	<div class="layui-input-inline">
				        		<input type="text" id="shipper_contact_code" name="shipper_contact_code" autocomplete="off" class="layui-input layui-hide">
			           			<input type="text" id="shipper_contact_name" name="shipper_contact_name" autocomplete="off" lay-verify="required" placeholder="请选择或输入联系人" class="layui-input popup col-xs-12"/>
						...
						<div class="layui-inline"> 
				        	...
				        	<div class="layui-input-inline">
								<input type="text" id="consignee_code" name="consignee_code" autocomplete="off" class="layui-input layui-hide">
			           			<input type="text" id="consignee_name" name="consignee_name" autocomplete="off" placeholder="请选择或输入客户" class="layui-input popup col-xs-12"/>
						...
						<div class="layui-inline"> 
				        	...
				        	<div class="layui-input-inline">
				        		<input type="text" id="consignee_contact_code" name="consignee_contact_code" autocomplete="off" class="layui-input layui-hide">
			           			<input type="text" id="consignee_contact_name" name="consignee_contact_name" autocomplete="off" placeholder="请选择或输入联系人" class="layui-input popup col-xs-12"/>
						...
						<div class="layui-inline"> 
				        	...
				        	<div class="layui-input-inline">
			           			<input type="text" id="shipper_contact_tel" name="shipper_contact_tel" autocomplete="off" lay-verify="tel" onkeyup="this.value=this.value.replace(/[^0-9-]+/,'');" class="layui-input">
			           		</div>
						</div>
						<div class="layui-inline"> 
						...
						<div class="layui-inline"> 
				        	<label class="layui-form-label">电话</label>
				        	<div class="layui-input-inline">
			           			<input type="text" id="consignee_contact_tel" name="consignee_contact_tel" autocomplete="off" lay-verify="tel" onkeyup="this.value=this.value.replace(/[^0-9-]+/,'');" class="layui-input">
			           		</div>
						</div>
						<!-- 第三行 -->
						<div class="layui-inline">
                            ...
                            <input type="text" id="shipper_address" name="shipper_address" lay-verify="required" autocomplete="off" class="layui-input" style="width:248px">
	                    </div>
	                    ...
	                    <div class="layui-inline">
							...
							<div class="layui-form-mid" style="padding-left: 9px">-</div>
							<input type="text" id="consignee_address" name="consignee_address" lay-verify="required" autocomplete="off" class="layui-input" style="width:248px">
						</div>
					</div>
				</div>
				<!-- 底部按钮 -->
				<div class="foot"> 
					...
					<button class="layui-btn layui-btn-small" id="btn-confirm" style="display: none;">确认</button>
					<button class="layui-btn layui-btn-small" id="btn-distribution" style="display: none;">分配</button>
					<button class="layui-btn layui-btn-small" id="btn-complete" style="display: none;">完成</button>
		...
		<div class="layui-colla-item">
			<div class="layui-tab layui-tab-card">
				<ul id="sub-tabs" class="layui-tab-title">
					...
					<li id="sub-distribution">分配信息</li>
					<li id="sub-send">派车信息</li>
					<li id="sub-purchase">合单明细</li>
				</ul>
				<div class="layui-tab-content">
					...
					<div class="layui-tab-item">
						<div class="layui-colla-content layui-show">
							<div class="btn-group">
								<a href="javascript:;" class="layui-btn layui-btn-small" id="btn-sub-distribution-delete"><i class="layui-icon">&#xe640;</i>删除</a>
							</div>
							<div class="layui-form">
								<table id="distributionTable" class="layui-table" lay-even="" width="100%" lay-skin="line">
									<thead>
										<tr>
											<th width="10"><input type="checkbox" name="" lay-skin="primary" lay-filter="allChoose"></th>
											<th style="width: 170px">分配单号</th>
											<th>承运商</th>
											<th>计划量</th>
											<th>已完成量</th>
											<th>未完成量</th>
					...
					<div class="layui-tab-item">
						<div class="layui-colla-content layui-show">
							<div class="layui-form">
								<table id="sendTable" class="layui-table" lay-even="" width="100%" lay-skin="line">
									<thead>
										<tr>
											<th>派车单号</th>
											<th>分配单号</th>
					...
					<div class="layui-tab-item">
						<div class="layui-colla-content layui-show">
							<div class="layui-form">
								<table id="purchaseTable" class="layui-table" lay-even="" width="100%" lay-skin="line">
									<thead>
									<tr>
										<th width="10"><input type="checkbox" name="" lay-skin="primary" lay-filter="allChoose"></th>
										<th>商户订单号</th>
...
<script type="text/javascript">
	layui.config({base: '${base}/view/oms/order/'}).use('csOrderForm');
</script> 
</body>
</html>