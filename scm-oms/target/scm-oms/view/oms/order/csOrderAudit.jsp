...
<body class="body-grey">
    <div class="container">
        <form class="layui-form form-search" action="" onsubmit="return false" method="get">
            <div class="row form-group">
				...
				<div class="col-xs-2_4"> 
		        	<label class="control-label col-xs-4">订单类型</label>
	           		<fm:select id="order_type_query" name="order_type" dictType="order_type" itemValue="value" itemLabel="label" cssClass="col-xs-7"></fm:select>
				</div>
				<div class="col-xs-2_4"> 
			...
			<div class="row form-group query-more">
				<div class="col-xs-2_4"> 
					...
					<fm:select id="customer_type_query" name="customer_type" dictType="customer_type" itemValue="value" itemLabel="label" cssClass="col-xs-7"></fm:select>
				</div>
				<div class="col-xs-2_4"> 
					<label class="control-label col-xs-4">结算方式</label>
					<fm:select id="charge_mode_query" name="charge_mode" dictType="charge_mode" itemValue="value" itemLabel="label" cssClass="col-xs-7"></fm:select>
				</div>
				<div class="col-xs-2_4"> 
        ...
        <div class="btn-group">
            ...
            <a href="javascript:void(0);" class="layui-btn layui-btn-small" id="btn-auto-distribution"><i class="layui-icon">&#xe601;</i>分配承运商</a>
            ...
            <a href="javascript:void(0);" class="layui-btn layui-btn-small" id="btn-audit-cancel"><i class="layui-icon">&#xe605;</i>取消审核</a>
            <a href="javascript:void(0);" class="layui-btn layui-btn-small" id="btn-issue"><i class="layui-icon">&#xe605;</i>下发</a>
    ...
    <script type="text/javascript">
        layui.config({base: '${base}/view/oms/order/'}).use('csOrderAudit');
    </script>
</body>
</html>
